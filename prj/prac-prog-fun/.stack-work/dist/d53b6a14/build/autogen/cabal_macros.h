...
/* package prac-prog-fun-0.0.0.1 */
#ifndef VERSION_prac_prog_fun
#define VERSION_prac_prog_fun "0.0.0.1"
#endif /* VERSION_prac_prog_fun */
#ifndef MIN_VERSION_prac_prog_fun
#define MIN_VERSION_prac_prog_fun(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  0 || \
  (major1) == 0 && (major2) == 0 && (minor) <= 0)
#endif /* MIN_VERSION_prac_prog_fun */
...
/* package drawing-0.2.2.0 */
#ifndef VERSION_drawing
#define VERSION_drawing "0.2.2.0"
#endif /* VERSION_drawing */
#ifndef MIN_VERSION_drawing
#define MIN_VERSION_drawing(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  2 || \
  (major1) == 0 && (major2) == 2 && (minor) <= 2)
#endif /* MIN_VERSION_drawing */
...
#define CURRENT_COMPONENT_ID "prac-prog-fun-0.0.0.1-LduzV01u2I2AYzWoQtnUWy"
